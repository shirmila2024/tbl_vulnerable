...
<!-- Mirrored from template.hasthemes.com/sinp/sinp/blog-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Mar 2024 04:24:58 GMT -->
<head>
    <meta charset="utf-8" />
        ...
        <div class="container">
            <div class="flex flex-wrap -my-4 -px-4">
                <div class="w-full px-4 my-4">
                    <div class="border border-solid border-gray-300 p-[20px] md:p-[30px] group flex flex-wrap items-center">
                        <div class="mb-6 lg:mb-0 lg:mr-8 w-full lg:w-1/2 xl:w-1/2">
                            <a href="blog-details.html" class="overflow-hidden block">
                                <img class="transform group-hover:scale-110 transition-transform duration-500 w-full" loading="lazy" width="600" height="400" src="assets/images/blog/blog1.webp" alt="blog image" />
                            </a>
                        </div>
                ...
                <div class="w-full px-4 my-4">
                    <div class="border border-solid border-gray-300 p-[20px] md:p-[30px] group flex flex-wrap items-center">
                        <div class="mb-6 lg:mb-0 lg:mr-8 w-full lg:w-1/2 xl:w-1/2">
                            <a href="blog-details.html" class="overflow-hidden block">
                                <img class="transform group-hover:scale-110 transition-transform duration-500 w-full" loading="lazy" width="600" height="400" src="assets/images/blog/blog2.webp" alt="blog image" />
                            </a>
                        </div>
                ...
                <div class="w-full px-4 my-4">
                    <div class="border border-solid border-gray-300 p-[20px] md:p-[30px] group flex flex-wrap items-center">
                        <div class="mb-6 lg:mb-0 lg:mr-8 w-full lg:w-1/2 xl:w-1/2">
                            <a href="blog-details.html" class="overflow-hidden block">
                                <img class="transform group-hover:scale-110 transition-transform duration-500 w-full" loading="lazy" width="600" height="400" src="assets/images/blog/blog3.webp" alt="blog image" />
                            </a>
                        </div>
                ...
                <div class="w-full px-4 my-4">
                    <div class="border border-solid border-gray-300 p-[20px] md:p-[30px] group flex flex-wrap items-center">
                        <div class="mb-6 lg:mb-0 lg:mr-8 w-full lg:w-1/2 xl:w-1/2">
                            <a href="blog-details.html" class="overflow-hidden block">
                                <img class="transform group-hover:scale-110 transition-transform duration-500 w-full" loading="lazy" width="600" height="400" src="assets/images/blog/blog4.webp" alt="blog image" />
                            </a>
                        </div>
                ...
                <div class="w-full px-4 my-4">
                    <div class="border border-solid border-gray-300 p-[20px] md:p-[30px] group flex flex-wrap items-center">
                        <div class="mb-6 lg:mb-0 lg:mr-8 w-full lg:w-1/2 xl:w-1/2">
                            <a href="blog-details.html" class="overflow-hidden block">
                                <img class="transform group-hover:scale-110 transition-transform duration-500 w-full" loading="lazy" width="600" height="400" src="assets/images/blog/blog5.webp" alt="blog image" />
                            </a>
                        </div>
                ...
                <div class="w-full px-4 my-4">
                    <div class="border border-solid border-gray-300 p-[20px] md:p-[30px] group flex flex-wrap items-center">
                        <div class="mb-6 lg:mb-0 lg:mr-8 w-full lg:w-1/2 xl:w-1/2">
                            <a href="blog-details.html" class="overflow-hidden block">
                                <img class="transform group-hover:scale-110 transition-transform duration-500 w-full" loading="lazy" width="600" height="400" src="assets/images/blog/blog6.webp" alt="blog image" />
                            </a>
                        </div>
