...
<!-- Mirrored from template.hasthemes.com/sinp/sinp/single-product-group.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Mar 2024 04:24:55 GMT -->
<head>
    <meta charset="utf-8" />
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap items-center mb-5">
                        ...
                        <div class="flex count border border-solid border-gray-300 p-2 h-14 mr-4">
                        ...
                        <div class="flex items-center">
                            <div class="mr-4">
                                <img class="h-20" src="assets/images/cart/product1.webp" alt="product image">
                            </div>
                            <div class="flex-1">
                                <h3 class="title">Airp Variable product</h3>
                                <span>$251</span>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-wrap items-center mb-5">
                        ...
                        <div class="flex items-center">
                            <div class="mr-4">
                                <img class="h-20" src="assets/images/cart/product2.webp" alt="product image">
                            </div>
                            <div class="flex-1">
                                <h3 class="title">Airp pod</h3>
                                <span>$251</span>
                            </div>
                        </div>
                    ...
                    <div class="my-8">
                        <button class="bg-black leading-none py-4 px-5 md:px-8 font-medium text-sm h-11 text-white transition-all hover:bg-orange uppercase">Add to Cart</button>
                    </div>
                    <div>
