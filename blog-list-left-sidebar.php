...
<!-- Mirrored from template.hasthemes.com/sinp/sinp/blog-list-left-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Mar 2024 04:24:55 GMT -->
<head>
    <meta charset="utf-8" />
        ...
        <div class="px-4 md:px-10 2xl:px-24 py-6 lg:py-0">
            <div class="flex items-center lg:relative">
                <div class="w-6/12 lg:w-2/12">
                    <div class="logo"><a href="index.html"><img src="assets/images/logo/logo.webp" alt="logo" loading="lazy" width="125" height="45" /></a></div>
                </div>
                <div class="hidden lg:flex flex-1 xl:relative">
                    <nav class="main-menu">
                        <ul class="flex flex-wrap">
                            <li class="main-menu__item relative group">
                                <a class="block py-10 xl:pr-6 md:pr-5 capitalize font-normal text-md text-primary hover:text-orange transition-all" href="https://template.hasthemes.com/">Home</a>
                            ...
                            <li class="main-menu__item group">
                                <a class="block py-10 xl:px-6 md:px-5 capitalize font-normal text-md text-primary hover:text-orange transition-all" href="#">Shop</a>
                            ...
                            <li class="main-menu__item relative group"><a class="block py-10 xl:px-6 md:px-5 capitalize font-normal text-md text-primary hover:text-orange transition-all" href="#">pages</a>
                                <ul class="submenu bg-white py-3 px-8 shadow transition-all absolute left-0 top-full opacity-0 group-hover:opacity-100 invisible group-hover:visible group-hover:-translate-y-3 transform z-10 min-w-max">
                                    ...
                                    <li class="my-3"><a class="text-dark font-normal text-base capitalize transition-all hover:text-orange" href="cart.html">Cart Page</a></li>
                                    <li class="my-3"><a class="text-dark font-normal text-base capitalize transition-all hover:text-orange" href="checkout.html">Checkout Page</a></li>
                    ...
                    <ul class="flex items-center justify-end">
                        ...
                        <li id="toggle-menu" class="ml-6 hidden lg:block relative">
                            ...
                            <div id="settings-card" class="bg-white absolute right-0 px-8 py-5 shadow w-80 opacity-0 invisible transition-all duration-300 ease-in-out z-20">
                                ...
                                <ul>
                                    <li class="my-4"><a href="#" class="text-base text-dark hover:text-orange transition-all font-light capitalize tracking-wide">USD - US Dollar</a></li>
                                    <li class="my-4"><a href="#" class="text-base text-dark hover:text-orange transition-all font-light capitalize tracking-wide">EUR - Euro</a></li>
                                    <li class="my-4"><a href="#" class="text-base text-dark hover:text-orange transition-all font-light capitalize tracking-wide">GBP - British Pound</a></li>
                                </ul>
                                ...
                                <ul>
                                    <li class="my-4"><a href="login-register.html" class="text-base text-dark hover:text-orange transition-all font-light capitalize tracking-wide">Login</a></li>
                                    <li class="mt-4"><a href="account.html" class="text-base text-dark hover:text-orange transition-all font-light capitalize tracking-wide">Create Account</a></li>
                                </ul>
                            </div>
                ...
                <div class="col-span-12">
                    <nav>
                        <ul class="flex flex-wrap items-center justify-center">
                            ...
                            <li class="text-dark font-medium text-base uppercase mr-5">blog list left sidebar</li>
                        </ul>
                    </nav>
                </div>
            </div>
        ...
        <div class="container">
            <div class="flex flex-wrap flex-col lg:flex-row -mx-4">
                <div class="lg:w-1/4 px-4 order-last lg:order-first mt-8 lg:mt-0">
                    <div>
                        <div class="mb-12">
                            <h4 class="font-medium text-lg xl:text-3xl text-dark capitalize mb-6">Search</h4>
                        ...
                        <div class="mb-12">
                            <h4 class="font-medium text-lg xl:text-3xl text-dark capitalize mb-5">Custom Menu</h4>
                            <ul>
                                <li class="mb-4"><a href="#" class="text-sm transition-all hover:text-orange">Best Value</a></li>

                                <li class="mb-4"><a href="#" class="text-sm transition-all hover:text-orange">Your Order</a></li>

                                <li class="mb-4"><a href="#" class="text-sm transition-all hover:text-orange">Terms &amp; Condition</a></li>

                                <li class="mb-4"><a href="#" class="text-sm transition-all hover:text-orange">Contact us</a></li>

                                <li class="mb-4"><a href="#" class="text-sm transition-all hover:text-orange">Manufactureres</a></li>
                            </ul>
                        </div>

                        <div class="mb-12">
                            <h4 class="font-medium text-lg xl:text-3xl text-dark capitalize mb-8">Recent Post</h4>
                            ...
                            <div class="sidebar-project-wrap mt-30">
                                <div class="flex flex-wrap pb-5 mb-5 border-b border-solid border-gray-300">
                                    <div class="w-20 mr-5 relative">
                                        <a href="#" class="block absolute top-0 left-0 h-full">
                                            <img class="object-cover w-full h-full" loading="lazy" width="240" height="114" src="assets/images/blog/sm/blog1.webp" alt="blog image" /></a>
                                    </div>
                                    <div class="flex-1">
                                        <span class="text-sm">Apr 21, 2021</span>
                                        <h4><a class="transition-all hover:text-orange text-sm" href="#">Sarbi at ligula porta</a></h4>
                                    </div>
                                </div>
                                ...
                                <div class="flex flex-wrap pb-5 mb-5 border-b border-solid border-gray-300">
                                    <div class="w-20 mr-5 relative">
                                        <a href="#" class="block absolute top-0 left-0 h-full">
                                            <img class="object-cover w-full h-full" loading="lazy" width="240" height="114" src="assets/images/blog/sm/blog2.webp" alt="blog image" /></a>
                                    </div>
                                    <div class="flex-1">
                                        <span class="text-sm">Apr 21, 2021</span>
                                        <h4><a class="transition-all hover:text-orange text-sm" href="#">Donec tellus Nulla lorem</a></h4>
                                    </div>
                                </div>
                                ...
                                <div class="flex flex-wrap">
                                    <div class="w-20 mr-5 relative">
                                        <a href="#" class="block absolute top-0 left-0 h-full">
                                            <img class="object-cover w-full h-full" loading="lazy" width="240" height="114" src="assets/images/blog/sm/blog3.webp" alt="blog image" /></a>
                                    </div>
                                    <div class="flex-1">
                                        <span class="text-sm">Apr 20, 2021</span>
                                        <h4><a class="transition-all hover:text-orange text-sm" href="#">Norbi at omgula qorta</a></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mb-12">
                            <h4 class="font-medium text-lg xl:text-3xl text-dark capitalize">Archive</h4>

                            <span class="font-medium text-base text-dark capitalize my-4 block"> April 2021</span>
                            <ul>
                                <li class="mb-4"><a class="text-sm transition-all hover:text-orange" href="#"><i class="icofont-rounded-right"></i> Sarbi at ligula porta</a></li>
                                <li class="mb-4"><a class="text-sm transition-all hover:text-orange" href="#"><i class="icofont-rounded-right"></i> Donec tellus Nulla lorem</a></li>
                                <li class="mb-4"><a class="text-sm transition-all hover:text-orange" href="#"><i class="icofont-rounded-right"></i> Norbi at omgula qorta</a></li>
                                <li class="mb-4"><a class="text-sm transition-all hover:text-orange" href="#"><i class="icofont-rounded-right"></i> Mithout wery warkness</a></li>
                            </ul>
                        </div>

                        <div>
                            <h4 class="font-medium text-lg xl:text-3xl text-dark capitalize mb-10">Tags</h4>

                            <ul class="flex flex-wrap -m-1">
                                <li class="m-1"><a href="#" class="bg-gray-light leading-none py-3 px-5 block text-sm transition-all hover:text-white hover:bg-orange">backpack</a></li>
                                <li class="m-1"><a href="#" class="bg-gray-light leading-none py-3 px-5 block text-sm transition-all hover:text-white hover:bg-orange">Dron</a></li>
                                <li class="m-1"><a href="#" class="bg-gray-light leading-none py-3 px-5 block text-sm transition-all hover:text-white hover:bg-orange">drone</a></li>
                                <li class="m-1"><a href="#" class="bg-gray-light leading-none py-3 px-5 block text-sm transition-all hover:text-white hover:bg-orange">headphone</a></li>
                                <li class="m-1"><a href="#" class="bg-gray-light leading-none py-3 px-5 block text-sm transition-all hover:text-white hover:bg-orange">news</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="flex-1 px-4">
                    <div class="flex flex-wrap -my-4 -px-4">
                        <div class="w-full px-4 my-4">
                            <div class="border border-solid border-gray-300 p-[20px] md:p-[30px] group flex flex-wrap">
                                <div class="mb-6 lg:mb-0 lg:mr-8 w-full lg:w-1/2 xl:w-1/2 relative">
                                    <a href="blog-details.html" class="overflow-hidden block lg:absolute lg:left-0 lg:top-0 lg:h-full">
                                        <img class="transform group-hover:scale-110 transition-transform duration-500 w-full h-full object-cover object-center" loading="lazy" width="600" height="400" src="assets/images/blog/blog1.webp" alt="blog image" />
                                    </a>
                                </div>

                                <div class="flex-1">
                                    <h3><a href="blog-details.html" class="block text-base md:text-md hover:text-orange transition-all font-medium pb-[10px] leading-[1.3]">Donec tellus Nulla lorem</a></h3>
                                    <div class="blog-meta">
                                        <ul class="flex flex-wrap mb-[10px]">
                                            <li class="text-sm"><a href="#" class="text-sm text-dark hover:text-orange transition-all">21 April, 2021</a> <span class="inline-block mx-2">\</span> </li>
                                            <li class="text-sm"><a href="#" class="text-sm text-dark hover:text-orange transition-all">0 comments</a></li>
                                        </ul>
                                    </div>
                        ...
                        <div class="w-full px-4 my-4">
                            <div class="border border-solid border-gray-300 p-[20px] md:p-[30px] group flex flex-wrap">
                                <div class="mb-6 lg:mb-0 lg:mr-8 w-full lg:w-1/2 xl:w-1/2 relative">
                                    <a href="blog-details.html" class="overflow-hidden block lg:absolute lg:left-0 lg:top-0 lg:h-full">
                                        <img class="transform group-hover:scale-110 transition-transform duration-500 w-full h-full object-cover object-center" loading="lazy" width="600" height="400" src="assets/images/blog/blog2.webp" alt="blog image" />
                                    </a>
                                </div>

                                <div class="flex-1">
                                    <h3><a href="blog-details.html" class="block text-base md:text-md hover:text-orange transition-all font-medium pb-[10px] leading-[1.3]">Norbi at omgula qorta</a></h3>
                                    <div class="blog-meta">
                                        <ul class="flex flex-wrap mb-[10px]">
                                            <li class="text-sm"><a href="#" class="text-sm text-dark hover:text-orange transition-all">21 April, 2021</a> <span class="inline-block mx-2">\</span> </li>
                                            <li class="text-sm"><a href="#" class="text-sm text-dark hover:text-orange transition-all">0 comments</a></li>
                        ...
                        <div class="w-full px-4 my-4">
                            <div class="border border-solid border-gray-300 p-[20px] md:p-[30px] group flex flex-wrap">
                                <div class="mb-6 lg:mb-0 lg:mr-8 w-full lg:w-1/2 xl:w-1/2 relative">
                                    <a href="blog-details.html" class="overflow-hidden block lg:absolute lg:left-0 lg:top-0 lg:h-full">
                                        <img class="transform group-hover:scale-110 transition-transform duration-500 w-full h-full object-cover object-center" loading="lazy" width="600" height="400" src="assets/images/blog/blog3.webp" alt="blog image" />
                                    </a>
                                </div>

                                <div class="flex-1">
                                    <h3><a href="blog-details.html" class="block text-base md:text-md hover:text-orange transition-all font-medium pb-[10px] leading-[1.3]">Mithout wery warkness</a></h3>
                                    <div class="blog-meta">
                                        <ul class="flex flex-wrap mb-[10px]">
                                            <li class="text-sm"><a href="#" class="text-sm text-dark hover:text-orange transition-all">21 April, 2021</a> <span class="inline-block mx-2">\</span> </li>
                                            <li class="text-sm"><a href="#" class="text-sm text-dark hover:text-orange transition-all">0 comments</a></li>
                        ...
                        <div class="w-full px-4 my-4">
                            <div class="border border-solid border-gray-300 p-[20px] md:p-[30px] group flex flex-wrap">
                                <div class="mb-6 lg:mb-0 lg:mr-8 w-full lg:w-1/2 xl:w-1/2 relative">
                                    <a href="blog-details.html" class="overflow-hidden block lg:absolute lg:left-0 lg:top-0 lg:h-full">
                                        <img class="transform group-hover:scale-110 transition-transform duration-500 w-full h-full object-cover object-center" loading="lazy" width="600" height="400" src="assets/images/blog/blog4.webp" alt="blog image" />
                                    </a>
                                </div>

                                <div class="flex-1">
                                    <h3><a href="blog-details.html" class="block text-base md:text-md hover:text-orange transition-all font-medium pb-[10px] leading-[1.3]">Sarbi at ligula porta</a></h3>
                                    <div class="blog-meta">
                                        <ul class="flex flex-wrap mb-[10px]">
                                            <li class="text-sm"><a href="#" class="text-sm text-dark hover:text-orange transition-all">21 April, 2021</a> <span class="inline-block mx-2">\</span> </li>
                                            <li class="text-sm"><a href="#" class="text-sm text-dark hover:text-orange transition-all">0 comments</a></li>
                        ...
                        <div class="w-full px-4 my-4">
                            <div class="border border-solid border-gray-300 p-[20px] md:p-[30px] group flex flex-wrap">
                                <div class="mb-6 lg:mb-0 lg:mr-8 w-full lg:w-1/2 xl:w-1/2 relative">
                                    <a href="blog-details.html" class="overflow-hidden block lg:absolute lg:left-0 lg:top-0 lg:h-full">
                                        <img class="transform group-hover:scale-110 transition-transform duration-500 w-full h-full object-cover object-center" loading="lazy" width="600" height="400" src="assets/images/blog/blog5.webp" alt="blog image" />
                                    </a>
                                </div>

                                <div class="flex-1">
                                    <h3><a href="blog-details.html" class="block text-base md:text-md hover:text-orange transition-all font-medium pb-[10px] leading-[1.3]">Smgori tuin nibes kninwe</a></h3>
                                    <div class="blog-meta">
                                        <ul class="flex flex-wrap mb-[10px]">
                        ...
                        <div class="w-full px-4 my-4">
                            <div class="border border-solid border-gray-300 p-[20px] md:p-[30px] group flex flex-wrap">
                                <div class="mb-6 lg:mb-0 lg:mr-8 w-full lg:w-1/2 xl:w-1/2 relative">
                                    <a href="blog-details.html" class="overflow-hidden block lg:absolute lg:left-0 lg:top-0 lg:h-full">
                                        <img class="transform group-hover:scale-110 transition-transform duration-500 w-full h-full object-cover object-center" loading="lazy" width="600" height="400" src="assets/images/blog/blog6.webp" alt="blog image" />
                                    </a>
                                </div>

                                <div class="flex-1">
                                    <h3><a href="blog-details.html" class="block text-base md:text-md hover:text-orange transition-all font-medium pb-[10px] leading-[1.3]">Minis mnies anide ewnis</a></h3>
                                    <div class="blog-meta">
                                        <ul class="flex flex-wrap mb-[10px]">
                                            <li class="text-sm"><a href="#" class="text-sm text-dark hover:text-orange transition-all">21 April, 2021</a></li>
                                        </ul>
