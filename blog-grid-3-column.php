...
<!-- Mirrored from template.hasthemes.com/sinp/sinp/blog-grid-3-column.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Mar 2024 04:24:47 GMT -->
<head>
    <meta charset="utf-8" />
                ...
                <div class="col-span-12">
                    <nav>
                        <ul class="flex flex-wrap items-center justify-center">
                            ...
                            <li class="text-dark font-medium text-base uppercase mr-5">blog</li>
                        </ul>
                    </nav>
                </div>
            </div>
            ...
            <div class="flex flex-wrap -my-4 -px-4">
                <div class="w-full md:w-1/2 lg:w-1/3 px-4 my-4">
                    <div class="border border-solid border-gray-300 p-[20px] md:p-[30px] group">
                        ...
                        <p class="font-normal text-black text-sm pb-[25px]">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore...</p>
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4 my-4">
                    <div class="border border-solid border-gray-300 p-[20px] md:p-[30px] group">
                        <div class="mb-6">
                            <a href="blog-details.html" class="overflow-hidden block">
                                <img class="transform group-hover:scale-110 transition-transform duration-500 w-full" src="assets/images/blog/blog7.webp" alt="blog image" />
                            </a>
                        </div>
                        <h3><a href="blog-details.html" class="block text-base md:text-md hover:text-orange transition-all font-medium pb-[10px] leading-[1.3]">Jininsi smart watch mnisyh</a></h3>
                        <div class="blog-meta">
                            <ul class="flex flex-wrap items-center pb-[10px]">
                                <li class="text-sm"><a href="#" class="text-sm text-dark hover:text-orange transition-all">21 April, 2021</a></li>
                            </ul>
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4 my-4">
                    <div class="border border-solid border-gray-300 p-[20px] md:p-[30px] group">
                        <div class="mb-6">
                            <a href="blog-details.html" class="overflow-hidden block">
                                <img class="transform group-hover:scale-110 transition-transform duration-500 w-full" src="assets/images/blog/blog8.webp" alt="blog image" />
                            </a>
                        </div>

                        <h3><a href="blog-details.html" class="block text-base md:text-md hover:text-orange transition-all font-medium pb-[10px] leading-[1.3]">Watch misni sdedn nises</a></h3>
                        <div class="blog-meta">
                            <ul class="flex flex-wrap items-center pb-[10px]">
                                <li class="text-sm"><a href="#" class="text-sm text-dark hover:text-orange transition-all">21 April, 2021</a></li>
                            </ul>
                ...
                <div class="w-full md:w-1/2 lg:w-1/3 px-4 my-4">
                    <div class="border border-solid border-gray-300 p-[20px] md:p-[30px] group">
                        <div class="mb-6">
                            <a href="blog-details.html" class="overflow-hidden block">
                                <img class="transform group-hover:scale-110 transition-transform duration-500 w-full" src="assets/images/blog/blog12.webp" alt="blog image" />
                            </a>
                        </div>

                        <h3><a href="blog-details.html" class="block text-base md:text-md hover:text-orange transition-all font-medium pb-[10px] leading-[1.3]">Onisw dia vansi kanei</a></h3>
                        <div class="blog-meta">
                            <ul class="flex flex-wrap items-center pb-[10px]">
                                <li class="text-sm"><a href="#" class="text-sm text-dark hover:text-orange transition-all">21 April, 2021</a></li>
                            </ul>
