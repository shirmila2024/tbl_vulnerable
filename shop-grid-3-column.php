...
<!-- Mirrored from template.hasthemes.com/sinp/sinp/shop-grid-3-column.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Mar 2024 04:24:47 GMT -->
<head>
    <meta charset="utf-8" />
                ...
                <div class="col-span-12">
                    <nav>
                        <ul class="flex flex-wrap items-center justify-center">
                            ...
                            <li class="text-dark font-medium text-base uppercase mr-5">shop-grid-3-column</li>
                        </ul>
                    </nav>
                </div>
            </div>
                            ...
                            <div class="flex flex-wrap -my-4 -mx-4">
                                        ...
                                        <div class="relative overflow-hidden">
                                            ...
                                            <div class="absolute left-2/4 top-2/4 transform -translate-x-2/4 -translate-y-2/4 z-10">
                                                <ul class="flex items-center justify-center bg-white shadow rounded-full h-0 transition-all group-hover:h-16 duration-500 overflow-hidden">
                                                    ...
                                                    <li class="py-4 pl-7 md:py-5 md:pl-8">
                                                        <a href="whishlist.html" class="text-dark flex items-center justify-center text-md hover:text-orange" aria-label="whishlist" data-tippy-content="Add to wishlist">
                                                    ...
                                                    <li class="py-4 pl-7 pr-7 md:py-5 md:pl-8 md:pr-8">
                                                        <a href="#modal-addto-cart" class="text-dark flex items-center justify-center text-md hover:text-orange modal-toggle" aria-label="quick view" data-tippy-content="Add to cart">
                                                            <i class="icon-bag"></i>
                                                        </a>
                                                    </li>
                                                </ul>
                                ...
                                <div class="w-full md:w-1/2 lg:w-1/3 px-4 py-4">
                                    <div class="border border-solid border-gray-300 transition-all hover:shadow-product group relative">
                                        <div class="relative overflow-hidden">
                                            <span class="font-medium uppercase text-sm text-black inline-block py-1 px-2 leading-none absolute top-3 right-3">Sale</span>
                                            <span class="font-medium uppercase text-sm text-black inline-block py-1 px-2 leading-none absolute top-10 right-3">-11%</span>
                                            <img class="w-full h-full" src="assets/images/products/bags/product1.webp" alt="product image" loading="lazy" width="432" height="480" />
                                            <!-- actions start -->
                                ...
                                <div class="w-full md:w-1/2 lg:w-1/3 px-4 py-4">
                                    <div class="border border-solid border-gray-300 transition-all hover:shadow-product group relative">
                                        ...
                                        <span class="font-medium uppercase text-sm text-black inline-block py-1 px-2 leading-none absolute top-3 right-3">Sale</span>
                                        <span class="font-medium uppercase text-sm text-black inline-block py-1 px-2 leading-none absolute top-10 right-3">-11%</span>
                                        <img class="w-full h-full" src="assets/images/products/bags/product2.webp" alt="product image" loading="lazy" width="432" height="480" />
                                ...
                                <div class="w-full md:w-1/2 lg:w-1/3 px-4 py-4">
                                    <div class="border border-solid border-gray-300 transition-all hover:shadow-product group relative">
                                        <div class="relative overflow-hidden">
                                            ...
                                            <span class="font-medium uppercase text-sm text-black inline-block py-1 px-2 leading-none absolute top-3 right-3">Sale</span>
                                            <span class="font-medium uppercase text-sm text-black inline-block py-1 px-2 leading-none absolute top-10 right-3">-11%</span>
                                            <img class="w-full h-full" src="assets/images/products/bags/product5.webp" alt="product image" loading="lazy" width="432" height="480" />
                                            <!-- actions start -->
                                ...
                                <div class="w-full md:w-1/2 lg:w-1/3 px-4 py-4">
                                    <div class="border border-solid border-gray-300 transition-all hover:shadow-product group relative">
                                        ...
                                        <span class="font-medium uppercase text-sm text-black inline-block py-1 px-2 leading-none absolute top-3 right-3">Sale</span>
                                        <span class="font-medium uppercase text-sm text-black inline-block py-1 px-2 leading-none absolute top-10 right-3">-11%</span>
                                        <img class="w-full h-full" src="assets/images/products/bags/product3.webp" alt="product image" loading="lazy" width="432" height="480" />
                                ...
                                <div class="w-full md:w-1/2 lg:w-1/3 px-4 py-4">
                                    <div class="border border-solid border-gray-300 transition-all hover:shadow-product group relative">
                                        <div class="relative overflow-hidden">
                                            ...
                                            <span class="font-medium uppercase text-sm text-black inline-block py-1 px-2 leading-none absolute top-3 right-3">Sale</span>
                                            <span class="font-medium uppercase text-sm text-black inline-block py-1 px-2 leading-none absolute top-10 right-3">-11%</span>
                                            <img class="w-full h-full" src="assets/images/products/bags/product4.webp" alt="product image" loading="lazy" width="432" height="480" />
                                            <!-- actions start -->
