...
<!-- Mirrored from template.hasthemes.com/sinp/sinp/blog-grid-left-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Mar 2024 04:24:47 GMT -->
<head>
    <meta charset="utf-8" />
                ...
                <div class="col-span-12">
                    <nav>
                        <ul class="flex flex-wrap items-center justify-center">
                            ...
                            <li class="text-dark font-medium text-base uppercase mr-5">blog left sidebar</li>
                        </ul>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="flex flex-wrap -my-4 -px-4">
                            ...
                            <div class="border border-solid border-gray-300 p-[20px] md:p-[30px] group">
                                <div class="mb-6">
                                    <a href="blog-details.html" class="overflow-hidden block">
                                        <img class="transform group-hover:scale-110 transition-transform duration-500 w-full" src="assets/images/blog/blog1.webp" alt="blog image" />
                                    </a>
                                </div>
                        ...
                        <div class="w-full md:w-1/2 lg:w-1/2 px-4 my-4">
                            <div class="border border-solid border-gray-300 p-[20px] md:p-[30px] group">
                                <div class="mb-6">
                                    <a href="blog-details.html" class="overflow-hidden block">
                                        <img class="transform group-hover:scale-110 transition-transform duration-500 w-full" src="assets/images/blog/blog2.webp" alt="blog image" />
                                    </a>
                                </div>
                        ...
                        <div class="w-full md:w-1/2 lg:w-1/2 px-4 my-4">
                            <div class="border border-solid border-gray-300 p-[20px] md:p-[30px] group">
                                <div class="mb-6">
                                    <a href="blog-details.html" class="overflow-hidden block">
                                        <img class="transform group-hover:scale-110 transition-transform duration-500 w-full" src="assets/images/blog/blog3.webp" alt="blog image" />
                                    </a>
                                </div>
                        ...
                        <div class="w-full md:w-1/2 lg:w-1/2 px-4 my-4">
                            <div class="border border-solid border-gray-300 p-[20px] md:p-[30px] group">
                                <div class="mb-6">
                                    <a href="blog-details.html" class="overflow-hidden block">
                                        <img class="transform group-hover:scale-110 transition-transform duration-500 w-full" src="assets/images/blog/blog4.webp" alt="blog image" />
                                    </a>
                                </div>
                        ...
                        <div class="w-full md:w-1/2 lg:w-1/2 px-4 my-4">
                            <div class="border border-solid border-gray-300 p-[20px] md:p-[30px] group">
                                <div class="mb-6">
                                    <a href="blog-details.html" class="overflow-hidden block">
                                        <img class="transform group-hover:scale-110 transition-transform duration-500 w-full" src="assets/images/blog/blog5.webp" alt="blog image" />
                                    </a>
                                </div>
                        ...
                        <div class="w-full md:w-1/2 lg:w-1/2 px-4 my-4">
                            <div class="border border-solid border-gray-300 p-[20px] md:p-[30px] group">
                                <div class="mb-6">
                                    <a href="blog-details.html" class="overflow-hidden block">
                                        <img class="transform group-hover:scale-110 transition-transform duration-500 w-full" src="assets/images/blog/blog6.webp" alt="blog image" />
                                    </a>
                                </div>
...
<!-- Mirrored from template.hasthemes.com/sinp/sinp/blog-grid-left-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Mar 2024 04:24:48 GMT -->
</html>